...
class Program {
  ...
  static class Duo {
    ...
    public Duo(int height, int diameter) {
      this.height = height;
      this.diameter = diameter;
    }
  }

  public static Duo diameter(Node root) {

    if (root == null) {
      return new Duo(-1, 0);
    }

    Duo l_hd = diameter(root.left);
    Duo r_hd = diameter(root.right);
